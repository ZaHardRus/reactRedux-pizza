...
export const CartItem = ({name, imageUrl, items, id}) => {
    ...
    return (
        <div className="cart__item">
            <div className={'cart__item-main-info'}>
                <h3>{name}</h3>
                <img
                    src={imageUrl}
                    alt="Pizza"
            ...
            <div className={'cart__item-sub-info'}>
                <div className='cart__pizza-info'>
                    <div className="cart__item-info">
                        <p className={'cart__item-config'} onClick={() => setPopupVisible(true)}>Проверить
                            конфигурацию</p>
                        {popupVisible &&
                        <CartPopup popupVisible={popupVisible} setPopupVisible={setPopupVisible} items={items}
                                   id={id}/>}
                    </div>
                </div>
