...
import {clearCartAC} from "../redux/redusers/cart";
...
export const Cart = () => {
    ...
    const isCartEmpty = !Object.values(items).filter(el=>el.items.length).length
    const onClearCart = () => {
                    ...
                    <div className="cart">
                        ...
                        <div className="cart__bottom">
                            <div className="cart__bottom-details">
                                ...
                                <span> Сумма заказа: <b>{new Intl.NumberFormat('RU-ru').format(totalPrice)} ₽</b> </span>
                            </div>
